...
class test_random_SUB_FP32(dut: AddSubPE_validate) extends PeekPokeTester(dut) {
...
class test_random_ADD_FP32(dut: AddSubPE_validate) extends PeekPokeTester(dut) {
...
class test_random_SUB_INT(dut: AddSubPE_validate) extends PeekPokeTester(dut) {
...
class test_random_ADD_INT(dut: AddSubPE_validate) extends PeekPokeTester(dut) {
...
class AddSubValidate_simple(dut: AddSubPE_validate) extends PeekPokeTester(dut) {
...
class AddSubValidate extends ChiselFlatSpec with Matchers {
    val vcdName = "AddSubValidate"
    val targetDir = "diagram/" + vcdName


  //   "run AddSubValidate_simple" should "pass" in {
  ...
  //     "--top-name" , vcdName,
  //     "--output-file", vcdName),
  //     () => new AddSubPE_validate ) { c =>
  //     new AddSubValidate_simple (c)
  //   } should be (true)
  // }
