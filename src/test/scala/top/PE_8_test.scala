...
class PE_8_test_manual(dut: PE_8) extends PeekPokeTester(dut) {
    ...
    // 2116  =  01000101000001000100000000000000
        // 7300  =  01000101111001000010000000000000
            ...
            // 29200 =  01000110111001000010000000000000
            // L2 = 58400 = 01000111011001000010000000000000
    //         L2 = 23 & 11 => 2304  =  01000101000100000000000000000000
    // ----------------------------------------------------
    // L1 => 208  =  01000011010100000000000000000000
    ...
    // L2 :  23 - 11 = 12^2  = 144 
    //      -55 + 11 = -44^2 = 1936 + 144 = 100 * 8 = 800   

    // ( (-59) - (-13) )^2 = 2116
    // L2 = 5184 + 2116 = 7300 * 8 = 58400
    // L1 = ( -59 - (-13) )   = -46 + 72 = 26 * 8 = 208
    // DOT = ( -59 * (-13) )  = -767 + 767 = 0 * 8 = 
    // WGT = ( -59 * (-13) )  = -767 + 767 = 0 * 8 = 0
  ...
  {  
    ...
    // inputTest_2 = "b"+"11111111111111111111111111001001" // -55
    // inputTest_3 = "b"+"11111111111111111111111111110101" // -11

    inputTest_0   = "b"+"00000000000000000000000000111011"  //  59
    inputTest_1   = "b"+"11111111111111111111111111110011"  // -13
    inputTest_2   = "b"+"11111111111111111111111111000101"  // -59
    inputTest_3   = "b"+"11111111111111111111111111110011"  // -13
  ...
  {  
    ...
    inputTest_2 = "b"+"11000010010111000000000000000000" // -55
    inputTest_3 = "b"+"11000001001100000000000000000000" // -11 
