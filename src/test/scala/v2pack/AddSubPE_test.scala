...
class test_random_SUB_FP32(dut: AddSubPE_4_testing) extends PeekPokeTester(dut) {
...
class test_random_ADD_FP32(dut: AddSubPE_4_testing) extends PeekPokeTester(dut) {
...
class test_random_SUB_INT(dut: AddSubPE_4_testing) extends PeekPokeTester(dut) {
...
class test_random_ADD_INT(dut: AddSubPE_4_testing) extends PeekPokeTester(dut) {
...
class AddSubPE_test_simple(dut: AddSubPE_4_testing) extends PeekPokeTester(dut) {
