...
class PE_v2pack_test_simple(dut: PE) extends PeekPokeTester(dut) {
    println(" ----->  PE simple test ")
    ...
    //poke(dut.io.rounding, rounding)
}

class PE_v2pack_test extends ChiselFlatSpec with Matchers {

val vcdName = "PE_v2pack_test"
val targetDir = "diagram/" + vcdName

 "run PE_v2pack_test_simple" should "pass" in {
