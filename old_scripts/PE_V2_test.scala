...
class PE_V2_test_manual(dut: PE_V2) extends PeekPokeTester(dut) {
...
class PE_V2_test extends ChiselFlatSpec with Matchers {
    val vcdName = "PE_V2_test"
    val targetDir = "diagram/" + vcdName


    "run PE_V2_test_manual" should "pass" in {
