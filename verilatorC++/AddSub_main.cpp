...
int main(int argc, char **argv, char **env) {
    ...
    Verilated::commandArgs(argc, argv);
    VAddSub_Top* top = new VAddSub_Top;
   ...
   top->reset = 0;
    ...
    vluint32_t test1 = 0b01010101111101100011011011001110;
    vluint32_t test2 = 0b01010110000000110001110000010110; 
    top->io_in1 = test1;
    top->io_in2 = test2;
    ...
    while (!Verilated::gotFinish()) 
    {
        ...
        cout << "exp:" << "01010110011111100011011101111101" << endl;
        cout << "OUT:" << std::bitset<32>( top->io_outIEEE ).to_string() << endl;
        main_time++;
